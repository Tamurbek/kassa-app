...
class _StockTransferScreenState extends State<StockTransferScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.transfer == null ? 'Omborlararo Ko\'chirish' : 'O\'tkazmani Tahrirlash', style: const TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: Center(
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            decoration: const InputDecoration(labelText: 'Qaysi ombordan', border: OutlineInputBorder(), prefixIcon: Icon(Icons.outbox_rounded, color: Colors.red)),
                        ...
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            value: toWarehouseId,
                            decoration: const InputDecoration(labelText: 'Qaysi omborga', border: OutlineInputBorder(), prefixIcon: Icon(Icons.inbox_rounded, color: Colors.green)),
                            items: inventory.warehouses.map((w) => DropdownMenuItem(value: w.id, child: Text(w.name))).toList(),
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Tavsif (izoh)', border: OutlineInputBorder(), prefixIcon: Icon(Icons.description_outlined)),
                    ),
                  ],
                ),
              ),
              ...
              const SizedBox(height: 32),
              const Text('Mahsulotlar ro\'yxati', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              const SizedBox(height: 16),
              ...
              const SizedBox(height: 16),
              OutlinedButton.icon(onPressed: () => setState(() => items.add({'productId': null, 'productName': '', 'quantity': 0.0})), icon: const Icon(Icons.add_rounded), label: const Text('Qator qo\'shish')),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('KO\'CHIRISHNI TASDIQLASH', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 0.5)),
                ),
              ),
            ],
          ),
